...
def user_not_found():
    ...
    Label(user_not_found_screen, text="Invalid User").pack()
...
def main_account_screen():
    ...
    main_screen.title("Login Application")
    Label(text="Welcome", bg="light green", width="300", height="2", font=("Calibri", 13)).pack()
    Label(text="").pack()
